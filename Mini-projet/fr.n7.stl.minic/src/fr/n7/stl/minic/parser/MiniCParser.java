...
public class MiniCParser extends Parser {
	...
	public static final int
		...
		DeuxPoint=10, Virgule=11, PointVirgule=12, Afficher=13, Si=14, While=15, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DeuxPoint", "Virgule", "PointVirgule", "Afficher", "Si", "While", "Sinon", 
	...
	public final BlocContext bloc() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2269119281815568L) != 0)) {
				{
				{
				setState(30);
	...
	public static class InstructionWhileContext extends InstructionContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MiniCParserListener ) ((MiniCParserListener)listener).enterInstructionWhile(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MiniCParserListener ) ((MiniCParserListener)listener).exitInstructionWhile(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case 6:
				...
				break;
			case 7:
				_localctx = new InstructionSiSansSinonContext(_localctx);
				...
				match(ParentheseFermante);
				setState(95);
				((InstructionSiSansSinonContext)_localctx).alors = bloc();
				}
				break;
			case 8:
				...
				match(ParentheseFermante);
				setState(101);
				((InstructionWhileContext)_localctx).alors = bloc();
				}
				break;
			case 9:
